...
public class BlockMemberAdapter extends RecyclerView.Adapter<BlockMemberAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.tvBlockWorkAs.setText(Utils.nullToBlank(item.city));
        holder.tvBlockState.setText(Utils.nullToBlank(item.state));
...
//                view.getContext().startActivity(intent, options.toBundle());*/
        ...
        holder.llViewProfileBlock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MatchPagerFragment.newInstance(String.valueOf(position), String.valueOf(list.size())).show(((FragmentActivity) context).getSupportFragmentManager(), "match_pager_fragment");
            }
...
//                    .into(holder.ivBlockProfileImage);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvBlockName, tvBlockAge,tvBlockState, tvLevelPremiumBlock, tvPremiumBlockMatch, tvNewBlockHeight, tvBlockCity, tvBlockWorkAs, tvImageCountUnBlock;
        LinearLayout llPhotoBlock, llViewProfileBlock, ivUnblock, llPrivateBlockPhoto, llConnectBlock, llNo_imageFemaleListBlock, llUnBlockAnimation, llPremiumMsgUnBlock;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            llViewProfileBlock = itemView.findViewById(R.id.llViewProfileBlock);
            tvBlockState=itemView.findViewById(R.id.tvBlockState);
